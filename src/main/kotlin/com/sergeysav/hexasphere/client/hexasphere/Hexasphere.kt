        ...
        geomMapper[tileEntity].apply {
            when (tile) {
                is HexasphereTile.Pentagon -> {
                    vertices[0].set(tile.v5)
                    vertices[1].set(tile.v4)
                    vertices[2].set(tile.v3)
                    vertices[3].set(tile.v2)
                    vertices[4].set(tile.v1)
                }
                is HexasphereTile.Hexagon -> {
                    vertices[0].set(tile.v6)
                    vertices[1].set(tile.v5)
                    vertices[2].set(tile.v4)
                    vertices[3].set(tile.v3)
                    vertices[4].set(tile.v2)
                    vertices[5].set(tile.v1)
                }
            }
        }
