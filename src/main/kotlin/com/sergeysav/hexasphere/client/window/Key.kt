...
fun Key.Companion.fromGLFWCode(code: Int) = when (code) {
    ...
    GLFW.GLFW_KEY_0 -> Key.KEY_0
    GLFW.GLFW_KEY_1 -> Key.KEY_1
    GLFW.GLFW_KEY_2 -> Key.KEY_2
    GLFW.GLFW_KEY_3 -> Key.KEY_3
    GLFW.GLFW_KEY_4 -> Key.KEY_4
    GLFW.GLFW_KEY_5 -> Key.KEY_5
    GLFW.GLFW_KEY_6 -> Key.KEY_6
    GLFW.GLFW_KEY_7 -> Key.KEY_7
    GLFW.GLFW_KEY_8 -> Key.KEY_8
    GLFW.GLFW_KEY_9 -> Key.KEY_9
